...
long long dp[1002][1002][4][4];
bool viz[1002][1002][4][4];
    ...
    while(!q.empty())
    {
        ...
        for(int dir = 0; dir <= 3; dir++)
        {
            ...
            if(nxtX >= 0 && nxtX < n && nxtY >= 0 && nxtY < m)
            {
                ...
                if(cntt <= 3 && !viz[nxtX][nxtY][dir][cntt])
                {
                ...
                {
                    if(cntt <= 3 && dp[nxtX][nxtY][dir][cntt] > dp[nod.L][nod.C][nod.dir][nod.consec] + (mat[nxtX][nxtY] - '0'))
                    {
                        viz[nxtX][nxtY][dir][cntt] = 1;
                        dp[nxtX][nxtY][dir][cntt] = dp[nod.L][nod.C][nod.dir][nod.consec] + (mat[nxtX][nxtY] - '0');
                        q.push({nxtX, nxtY, dir, cntt});
